...
///
/// The MainScreen class implements the Screen interface and acts as the entry point for
/// console-based user interaction. It provides rendering logic, handles user input,
/// and delegates commands to appropriate subsystems.
///
/// This class follows the singleton pattern to ensure only one instance of the main menu exists.
...
public:
    ...
    /// @brief Handles user input, parses commands, and performs corresponding actions.
